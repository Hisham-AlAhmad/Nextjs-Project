  ...
  return (
    <form onSubmit={handleSubmit} className={styles.form}>
      ...
      <div className={styles.field}>
        ...
        <p className={styles.helperText}>Upload an image or paste an image URL for blog cards and post header.</p>
        ...
        />
        {form.coverImage && (
          <img src={form.coverImage} alt="Blog cover preview" className={styles.imagePreview} style={{ maxWidth: '260px', borderRadius: '10px' }} />
        )}
      </div>
